...
SOURCE = "decomposition_explained.md"
...
def main():
    md_path = os.path.join(HERE, SOURCE)
    pdf_path = md_path[:-3] + ".pdf"
    html = md_to_html(read_text(md_path))
    # Ghi HTML tam vao chinh thu muc docs/ de duong dan anh ./erd_chen.png hoat dong
    tmp_html = os.path.join(HERE, "_print_decomp.html")
